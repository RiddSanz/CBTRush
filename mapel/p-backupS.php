...
*/
            ...
            */
            ...
            $dsoal[$nomor]['opsi_esay'] = trim($dr['opsi_esay']);// isi 0
            $dsoal[$nomor]['point_soal'] = trim($dr['point_soal']); // isi 1
            $dsoal[$nomor]['tingkat_kesulitan'] = trim($dr['tingkat_kesulitan']); // isi 1
        ...
        $ourFileName = trim($nm_mapel)."/".$file_name.".dat";
        ...
        $result = array();
        $directory = new DirectoryIterator(trim($nm_mapel).'/');
