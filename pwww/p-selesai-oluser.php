...
if (isset($_GET['ajax']) && isset($_GET['id'])) {
	...
	if ($bc['diselesaikan']=='0') {
		$sql = "update t_test_peserta set diselesaikan='1' where id_peserta='$iduser' 
		and id_test='$idtest' LIMIT 1";
	}
	else
	{
		$sql = "update t_test_peserta set diselesaikan='0' where id_peserta='$iduser' 
		and id_test='$idtest' LIMIT 1";
	}	
